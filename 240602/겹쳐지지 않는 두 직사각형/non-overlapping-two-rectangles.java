...
public class Main {
    			    	...
    			    	for(int x21 = 1; x21 <= m; x21++) {
    			    		for(int y22 = y21; y22 <= n; y22++) {
    			    			for(int x22 = x21; x22 <= m; x22++) {
    			    				if(notFold(y11, x11, y12, x12, y21, x21, y22, x22))	//	두 직사각형이 겹치지 않을 경
  ...
  private static boolean notFold(int y11, int x11, int y12, int x12, int y21, int x21, int y22, int x22) {
